...
# -*- coding: utf-8 -*-
"""
Build the final manuscript-associated PAT/AEM input from 29A_3_01_final_object_registry.csv.
    ...
    mat = pd.DataFrame(
        {
            ...
            # Compatibility fields required by the original PAT v2 / build_ADT_v1 code.
            "source_column": final["structure_model"].fillna(""),
            "alignment3_boundary_left": final["alignment_start"],
            "alignment3_boundary_right": final["alignment_end"],
